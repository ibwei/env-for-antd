<template>
  <div class="drag" ref="dragDiv">
    ...
    <div class="drag_text subTitleSize">{{ confirmWords }}</div>
    <div ref="moveDiv" @mousedown="mousedownFn($event)" @touchstart="mousedownFn($event)" :class="{ handler_ok_bg: confirmSuccess }" class="handler handler_bg" style="position: absolute; top: -1px; left: 0px;"></div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    moseUpFn: function (e) {
      ...
      if (touch) {
        width = touch.clientX - this.beginClientX
      }
